  ...
  <div className="flex items-center justify-between mb-8 px-2">
    <div className="flex flex-col gap-1">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-white text-lg font-bold tracking-tight">Revenue Over Time</h3>
      </div>
      {/* <p className="text-slate-500 text-[11px] font-semibold uppercase tracking-[0.2em] ml-4">
    ...
    <div className="bg-white/5 border border-white/10 px-3 py-1 rounded-full ">
      <span className="text-[10px] text-[#90c55a] font-bold uppercase tracking-wider">Live Updates</span>
    </div>
  </div>
